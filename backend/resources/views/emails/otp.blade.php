                            ...
                            <tr>
                                <td style="text-align: left; padding: 0 0em;">
                                    ...
                                    <div class="text-author">
                                        ...
                                        <span class="position">Here is your 6 digit token below to complete your transaction.</span>

                                        <h3 style="text-align: center; margin: 10px 0px; font-size:40px;">{{ $otp->code }}</h3>
