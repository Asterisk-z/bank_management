                            ...
                            <tr>
                                <td style="text-align: center;">
                                    <div class="text-author">
                                        ...
                                        <h3 class="name" style="font-weight: bolder; font-size: 20px">Forget Password Email</h3>

                                        <span class="position" style="display: inline-block; padding-top: 15px; padding-bottom: 15px;">You can reset password from bellow link</span>

                                        <p><a href="{{ $token }}" class="btn btn-primary btn-block">Reset Password</a></p>
