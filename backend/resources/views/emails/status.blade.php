                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                                    ...
                                                                    <div class="space-y-4">
                                                                        <h1 class="text-4xl fw-800" style="padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0; text-transform:capitalize;" align="left">{{ $subject }}</h1>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 300 !important; margin: 0;" align="left">
                                                                                        <p>Best Regards. <br>RoyalBank Team. </p>
