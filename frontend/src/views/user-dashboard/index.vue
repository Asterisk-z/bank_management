<template>
    <div>
        ...
        <div class="grid grid-cols-12 gap-5 mb-5">
            <!-- <div class="2xl:col-span-12 lg:col-span-12 md:col-span-12 col-span-12 ">
                <KycNotifier />
            </div> -->
                ...
                <Card bodyClass="p-4">
                        ...
                        <div v-for="(item, i) in statistics1" :key="i">
                            <Card :bodyClass="`pt-4 pb-3 px-4 ${item.bg} rounded-lg h-[8em]`">
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    <div class="flex-1">
                                        <div
                                            class="text-slate-600 dark:text-slate-300 text-[12px] font-medium ml-6 mb-3 mt-2">
                                            {{ item.title }}
                                        </div>
                                    ...
                                    <div class="">
                                        <Chart :type="item.chartType" :option="item.chart.chartOptions"
                                            :series="item.chart.series" :height="item.chartHeight"
                                            :width="item.chartWeight" class="float-left" />
                                    </div>
                                </div>
                            </Card>
                        </div>
                    ...
                    <Card title="Recent Transactions" noborder>
                        ...
                        <template v-if="transactions">
                            <vue-good-table :columns="columns" styleClass=" vgt-table  lesspadding2   v-middle"
                                :rows="transactions" :sort-options="{
                                    enabled: false,
                                }">
                            ...
                            <div class="flex-1">
                                <div class="max-w-[180px]">
                                    <h4 class="text-2xl font-medium text-white mb-2">
                                        ...
                                        <span class="block text-slate-600 dark:text-slate-300">{{ '$' + card_balance
                                            }}</span>
                                    </h4>
                                </div>
                            </div>
                            <div class="flex-none">
                                <Button icon="heroicons-outline:eye" text="View"
                                    btnClass="btn-primary bg-primary btn-sm " v-if="card_balance != 0" />
                            </div>
                        </div>
                        ...
                        <div class="w-auto h-56 m-auto bg-red-100 rounded-xl relative text-white shadow-2xl"
                            ...
                            <div class="w-full px-8 absolute bottom-5">
                                ...
                                <div class="pt-0 pb-3">
                                    ...
                                    <p
                                        class="font-medium tracking-more-wider tracking-[.25em] md:text-[12px] text-[14px]">
                                        <span class="mr-2">{{ card_number[0] }}</span> <span class="mr-2">XXXX</span>
                                        <span class="mr-2">XXXX</span> <span class="mr-2">XXXX</span>
                                    </p>
                                </div>
                                <div class="pt-2 pr-6">
...
import KycNotifier from "@/views/user-dashboard/components/KycNotifier.vue";
