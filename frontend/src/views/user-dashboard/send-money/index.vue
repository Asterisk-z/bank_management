      ...
      <Card title="Send Money">
        ...
        <form @submit.prevent="onSubmit" class="space-y-4" enctype="multipart/form-data">
          ...
          <div class="grid lg:grid-cols-1 md:grid-cols-1 grid-cols-1 gap-5">
            <InputGroup type="text" label="Email Or Account Number" placeholder="Email Or Account" v-model="recipient" :error="recipientError"
              classInput="h-[48px]">
            </InputGroup>
...
export default {
  ...
  methods: {
      ...
      fetch_history() {
        ...
        axios.post(`${import.meta.env.VITE_APP_API_URL}/customer/send_money_history`, {}, {
          headers: {
  ...
  setup() {
    ...
    const onSubmit = handleSubmit((values) => {
      ...
      axios.post(`${import.meta.env.VITE_APP_API_URL}/customer/send_money`, fromData, {
        headers: {
