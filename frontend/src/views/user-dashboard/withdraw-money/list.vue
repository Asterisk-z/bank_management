    ...
    <div>
        ...
        <Card noborder>
            <div class="md:flex pb-6 items-center">
                <h6 class="flex-1 md:mb-0 mb-3">Withdraw Request</h6>
    ...
    externalQuery: searchTerm,
                        ...
                        <template v-slot:table-row="props">
                            ...
                            <span v-if="props.column.field == 'due_amount'" class="font-medium">
                                {{ props.row.currency + " " + (parseFloat(props.row.total_payable) -
                                    parseFloat(props.row.total_paid)).toLocaleString("en-US") }}
                            </span>
...
export default {
    ...
    methods: {
        ...
        async fetch_transactions() {
            const data = await axios.post(`${import.meta.env.VITE_APP_API_URL}/customer/withdraw_requests`, {}, {
                headers: {
