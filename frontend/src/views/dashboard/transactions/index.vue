...
export default {
    ...
    methods: {
        ...
        fetch_all() {
            ...
            axios.post(`${import.meta.env.VITE_APP_API_URL}/admin/list_transaction`, {}, {
                headers: {
                    "Authorization": "Bearer " + this.$store.authStore.user.token
                }
            }).then(function (response) {
        ...
        fetch_approved() {
            ...
            axios.post(`${import.meta.env.VITE_APP_API_URL}/admin/list_transaction_approved`, {}, {
                headers: {
                    "Authorization": "Bearer " + this.$store.authStore.user.token
                }
            }).then(function (response) {
        ...
        fetch_pending() {
            ...
            axios.post(`${import.meta.env.VITE_APP_API_URL}/admin/list_transaction_pending`, {}, {
                headers: {
                    "Authorization": "Bearer " + this.$store.authStore.user.token
                }
            }).then(function (response) {
        ...
        fetch_declined() {
            ...
            axios.post(`${import.meta.env.VITE_APP_API_URL}/admin/list_transaction_declined`, {}, {
                headers: {
                    "Authorization": "Bearer " + this.$store.authStore.user.token
                }
            }).then(function (response) {
