    ...
    <div>
        <Card noborder>
            <div class="md:flex pb-6 items-center">
                <h6 class="flex-1 md:mb-0 mb-3">Currencies</h6>
            ...
            <div class="-mx-6">
                <template v-if="currencies">
                    <vue-good-table :columns="columns" styleClass=" vgt-table  centered " :rows="currencies"
                        :sort-options="{
                            enabled: false,
                        }" :pagination-options="{
                            enabled: true,
                        ...
                        <template #pagination-bottom="props">
                            <div class="py-4 px-3">
                                <Pagination :total="currencies.length" :current="current" :per-page="perpage"
...
export default {
    ...
    methods: {
        ...
        fetch_all() {
            ...
            axios.post(`${import.meta.env.VITE_APP_API_URL}/admin/list_currency`, {}, {
                headers: {
                    "Authorization": "Bearer " + this.$store.authStore.user.token
                }
            }).then(function (response) {
