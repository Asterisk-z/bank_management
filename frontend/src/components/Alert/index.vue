<template>
  <div v-if="!isDestroy" class="py-[18px] px-6 font-normal text-sm rounded-md" :class="alertClass() + ' ' + className">
    <div class="flex items-start space-x-3 rtl:space-x-reverse">
      ...
      <div class="flex-0 text-2xl cursor-pointer" @click="destroy" v-if="dismissible">
